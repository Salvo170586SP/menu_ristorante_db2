<x-app-layout>
    <div class="container  mx-auto flex flex-col justify-center">
        ...
        <h1 class="text-3xl my-9">Modifica Bottiglia</h1>
        ...
        <div class="mx-auto">
            <form action="{{ route('admin.bottles.update', $bottle->id) }}" method="post" class="flex flex-col align-center justify-center">
                @csrf
                @method('put')
