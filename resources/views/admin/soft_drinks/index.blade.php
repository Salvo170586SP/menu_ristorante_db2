<x-app-layout>
    <div class="container  mx-auto flex flex-col justify-center">
        ...
        <div class="flex justify-between align-center py-5">
            <h5 class="text-lg">Totale dei prodotti in tabella: {{ count($soft_drinks) }}</h5>
            <a href="{{ route('admin.soft_drinks.create') }}" class="rounded-lg shadow text-white py-3 px-5  bg-gray-600 mx-2">Crea</a>
        </div>
        ...
        <table class="table-auto bg-white border-separate border-spacing-2 shadow mt-5">
            ...
            <tbody class="text-center">
                ...
                <tr>
                    ...
                    <td>@if($soft_drink->cl) {{ $soft_drink->cl }}cl @else -- @endif</td>
                    <td>@if($soft_drink->price) €{{ $soft_drink->price }} @else -- @endif</td>
                    <td>
                        <div class="flex justify-end">
                            <a href="{{ route('admin.soft_drinks.show', $soft_drink->id) }}" class="rounded-lg shadow text-white p-2 bg-slate-500">Vedi</a>
                            <a href="{{ route('admin.soft_drinks.edit', $soft_drink->id) }}" class="rounded-lg shadow text-white p-2 bg-cyan-700 mx-2">Modifica</a>
                ...
                @empty
                <tr>
                    <td>Non ci sono soft drink in lista</td>
                </tr>
                @endforelse
            </tbody>
        </table>
