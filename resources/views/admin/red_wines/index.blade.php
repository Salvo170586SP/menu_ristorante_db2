<x-app-layout>
    <div class="container  mx-auto flex flex-col justify-center">
        ...
        <div class="flex justify-between align-center py-5">
            <h5 class="text-lg">Totale dei prodotti in tabella: {{ count($red_wines) }}</h5>
            <a href="{{ route('admin.red_wines.create') }}" class="rounded-lg shadow text-white py-3 px-5  bg-gray-600 mx-2">Crea</a>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="flex justify-end">
                            <a href="{{ route('admin.red_wines.show', $red_wine->id) }}" class="rounded-lg shadow text-white p-2 bg-slate-500	">Vedi</a>
                            <a href="{{ route('admin.red_wines.edit', $red_wine->id) }}" class="rounded-lg shadow text-white p-2 bg-cyan-700 mx-2">Modifica</a>
