<x-app-layout>
    <div class="container  mx-auto flex flex-col justify-center">
        ...
        <div class="flex justify-between align-center py-5">
            <h5 class="text-lg">Totale dei prodotti in tabella: {{ count($whiskies) }}</h5>
            <a href="{{ route('admin.whiskies.create') }}" class="rounded-lg shadow text-white py-3 px-5  bg-gray-600 mx-2">Crea</a>
        </div>
        ...
        <table class="table-auto bg-white border-separate border-spacing-2 shadow mt-5">
            ...
            <tbody class="text-center">
                ...
                <tr>
                    ...
                    <td>@if($whisky->cl) {{ $whisky->cl }}cl @else -- @endif</td>
                    <td>@if($whisky->price) €{{ $whisky->price }} @else -- @endif</td>
                    <td>
                        <div class="flex justify-end">
                            <a href="{{ route('admin.whiskies.show', $whisky->id) }}" class="rounded-lg shadow text-white p-2 bg-slate-500">Vedi</a>
                            <a href="{{ route('admin.whiskies.edit', $whisky->id) }}" class="rounded-lg shadow text-white p-2 bg-cyan-700 mx-2">Modifica</a>
