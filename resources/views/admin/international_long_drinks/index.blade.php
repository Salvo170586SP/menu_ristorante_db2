<x-app-layout>
    <div class="container  mx-auto flex flex-col justify-center">
        ...
        <div class="flex justify-between align-center py-5">
            ...
            <a href="{{ route('admin.international_long_drinks.create') }}" class="rounded-lg shadow text-white py-3 px-5  bg-gray-600 mx-2">Crea</a>
        </div>
        ...
        <table class="table-auto bg-white border-separate border-spacing-2 shadow mt-5">
            ...
            <tbody class="text-center">
                ...
                <tr>
                    ...
                    <td>@if($international_long_drink->price) €{{ $international_long_drink->price }} @else -- @endif</td>
                    <td>
